...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="modified_rag",
    ...
    if model_name == "vanilla_baseline":
        ...
        model = MyRAGModel(llm_name=llm_name, is_server=args.is_server, vllm_server=args.vllm_server)
    elif model_name == "prompt_rag_bsln":
        from prompt_rag_bsln import MyRAGModel
        model = MyRAGModel(llm_name=llm_name, is_server=args.is_server, vllm_server=args.vllm_server)
    else:
    ...
    dataset_paths = [i for i in glob.glob("/home/jupyter/CRAG/data/crag_task_3_dev_v4/" + "*.jsonl")]
